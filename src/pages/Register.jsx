...
function Register() {
  ...
  const { signup, isAuthenticated, error: registerError, isLoading } = UseAuth()
  ...
  return (
    <div className='max-w-md m-auto my-10 p-10 bg-blue-200 border-[#f9b000] border-4 rounded-lg'>
      ...
      {
        isLoading ? <h3 className='text-blue-500 text-2xl my-2 font-semibold'>Creando nuevo usuario... </h3>
          :
